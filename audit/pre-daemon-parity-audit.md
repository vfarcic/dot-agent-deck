...
- Preserved: 44 (rows 1–13, 16–35, 37–47)
- Regressed: 1 (row 14 / **F1**)
- Intentional change: 2 (rows 15, 36)
- Unclear: 0

Total: 47 rows. Row 24 is plain Preserved — the documented-but-unimplemented `y` / `n` keybinding survives unchanged from baseline; see **F2** for the underlying defect.
