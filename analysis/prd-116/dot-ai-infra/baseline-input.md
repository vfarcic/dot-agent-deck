...
Regenerate this snapshot with the commands recorded in
[`../../../docs/develop/prd-116-baseline-regeneration.md`](placeholder) (see M3.3) — for
Phase 1 it was captured by hand from the commands below.
