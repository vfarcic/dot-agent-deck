...
- [Desktop GUI developer preview](docs/develop/desktop-gui.md) — install, run, and verify the opt-in Tauri control deck in deterministic fixture or live-daemon mode, including its trust boundary and current M0/M1 limits.
