...
##### status/supersede/017 — The reconnect overlay takes only fresher evidence: a card the upsert keeps is overlaid only by a newer, non-future snapshot, and a minted card changes no newest-wins pick (issue #804, PRD #1223).
