...
impl AgentPtyRegistry {
    ...
    pub fn spawn_agent(&self, mut opts: SpawnOptions<'_>) -> Result<String, AgentPtyError> {
        ...
        // PRD #20 finding #15: dispatch this spawn-time materialize through the
        // agent's OWN registry handler (`spec.materialize`) rather than a
        // strategy-keyed hardcoded incumbent. Today only Pi (`orchestrator_ext`)
