...
const crowdedAgents: AgentSession[] = [
  crowdedAgent({ id: "2", displayName: "coder", role: "Coder", cli: "claude_code", status: "running", cwd: PRD_CWD, toolCount: 132, upForMinutes: 41, quietForMinutes: 0, activeTool: "edit", activeToolDetail: "desktop/src/components/AgentOverview.tsx", writeLease: "write", lastUserPrompt: "Surface the honest fields and stop presenting attempt and branch as facts.", tab: orchestrationTab("orc-745", "dot-agent-deck", "PRD #745 · agent overview", "coder", 1, false, PRD_CWD) }),
  ...
  crowdedAgent({ id: "1", displayName: "orchestrator", role: "Orchestrator", cli: "claude_code", status: "running", cwd: PRD_CWD, toolCount: 47, upForMinutes: 194, quietForMinutes: 0, activeTool: "read", activeToolDetail: "prds/745-desktop-agent-overview-landing-screen.md", writeLease: "write", lastUserPrompt: "Run PRD #745 to done: delegate each milestone and verify the gates yourself.", tab: orchestrationTab("orc-745", "dot-agent-deck", "PRD #745 · agent overview", "orchestrator", 0, true, PRD_CWD) }),
  ...
  crowdedAgent({ id: "12", displayName: "Security pass", role: "Claude code", cli: "claude_code", status: "waiting", cwd: DECK_CWD, toolCount: 7, upForMinutes: 27, quietForMinutes: 9, tab: { kind: "mode", name: "review" } }),
];
