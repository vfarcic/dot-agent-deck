...
### Phase 2: Return-edge routing — NOT SHIPPED; deferral premise revised 2026-09-10
...
- [ ] **M2.2** — The pane-is-gone fallback (drop-and-log, or hand to #630) and the delivery mode (submit vs notice), per the two gaps above.
- [ ] **M2.3** — Cover `--single`, or state in the docs that the return edge is orchestration-only.
