...
**Origin**: Follow-up to [PRD #20](done/20-multi-agent-support.md) (multi-agent machinery + Codex adapter), created as one of its final tasks. This PRD reuses the wrapper strategy PRD #20 shipped and proved with Codex.
