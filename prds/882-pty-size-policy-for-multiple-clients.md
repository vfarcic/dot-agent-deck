...
- **Option 3** — #883 exactly as scoped: compare against `AgentRecord.rows/cols` rather than the local parser, re-assert on attach/focus, and accept the ring clear.
